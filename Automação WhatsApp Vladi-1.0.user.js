...
const MINHA_KEY = 'vladimir.sousa'; // chave única
...
(function () {
    ...
    function adicionarIconeMarcaDagua() {
        ...
        textoMarcaDagua.innerHTML = 'ESTÁGISCRAVO DE VLADI ATIVO!<span style="display:inline-block; width:5px;"></span>'; // mensagem única em cada pc
