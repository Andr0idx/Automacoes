// ==UserScript==
// @name         Automação WhatsApp Elliel
...
const MINHA_KEY = 'elliel.souza'; // chave única
...
(function () {
    ...
    function adicionarIconeMarcaDagua() {
        ...
        textoMarcaDagua.innerHTML = 'ESTÁGISCRAVO DE ELLIEL ATIVO!<span style="display:inline-block; width:5px;"></span>'; // mensagem única em cada pc
