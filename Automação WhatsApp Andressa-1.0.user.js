// ==UserScript==
// @name         Automação WhatsApp Andressa
...
const MINHA_KEY = 'andressa.moreira'; // chave única
...
(function () {
    ...
    function adicionarIconeMarcaDagua() {
        ...
        textoMarcaDagua.innerHTML = 'ESTÁGISCRAVO DE ANDRESSA ATIVO!<span style="display:inline-block; width:5px;"></span>'; // mensagem única em cada pc
